...
#op3
unban="/unban", "op3" #ok
send_dm="/send-dm", "op3" #ok
edit_dm="/edit-dm", "op3" #ok
del_dm="/del-dm", "op3" #ok
get_dm="/get-dm", "op3"#ok
statistics="/statistics", "op3" #ok simple,normal
spam="/spam", "op3" #ok
alert="/alert", "op3" #ok
send_msg="/send-msg", "op3" #ok
edit_msg="/edit-msg", "op3" #ok
get_msg_log="/get-log", "op3" #ok
ls="/ls", "op3" #ok
